      ...
      <div className="row g-4 g-lg-5">
        <div className="col-12 col-xl-9 overflow-hidden">
          <div className="mb-5 pb-3">
            <h1 className="mb-2 fw-light display-4 text-primary" style={{ letterSpacing: '-0.04em', color: '#152d61 !important' }}>Tabs</h1>
                  ...
                  {tabs.map(tab => (
                    <li key={tab} className="nav-item">
                      <button
                        ...
                        style={{
                          borderBottom: active === tab ? '2px solid #152d61' : '2px solid transparent',
                          borderRadius: 0,
                          background: 'transparent',
                          marginBottom: '-2px',
                          color: active === tab ? '#152d61' : '#5f6368',
                        }}
                        type="button"
                      >
                        {tab}
                  ...
                  {[['home','Home'], ['person','Profile'], ['settings','Settings']].map(([icon, label], i) => (
                    <li key={label} className="nav-item">
                      <button
                        ...
                        type="button"
                        style={{
                          borderBottom: i === 0 ? '2px solid #152d61' : '2px solid transparent',
                          color: i === 0 ? '#152d61' : '#5f6368',
                          borderRadius: 0,
                          background: 'transparent',
                          marginBottom: '-2px',
                        }}
