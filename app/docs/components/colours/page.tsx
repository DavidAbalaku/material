...
const m3Tones = [
  { label: 'Primary', hex: '#152d61', on: '#ffffff', container: '#DBDEE6', onContainer: '#174ea6' },
      ...
      <div className="row g-4 g-lg-5">
        <div className="col-12 col-xl-9 overflow-hidden">
          <div className="mb-5 pb-3">
            <h1 className="mb-2 fw-light display-4 text-primary" style={{ letterSpacing: '-0.04em', color: '#152d61 !important' }}>Colours</h1>
